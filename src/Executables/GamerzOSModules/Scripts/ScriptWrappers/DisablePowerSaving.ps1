...
# Duplicate Ultimate Performance power scheme, customize it and make it the GamerzOS power scheme
...
powercfg /changename scheme_current "GamerzOS Power Scheme" "Power scheme optimized for optimal latency and performance."
...
& "$windir\GamerzOSModules\Scripts\toggleDev.cmd" -Disable '@("ACPI Processor Aggregator", "Microsoft Windows Management Interface for ACPI")' | Out-Null
