...
if %errorlevel%==1 (
	start "Enabling Hibernation" "%windir%\GamerzOSDesktop\3. General Configuration\Hibernation\Enable Hibernation.cmd"
) else (
	start "Disabling Hibernation" "%windir%\GamerzOSDesktop\3. General Configuration\Hibernation\Disable Hibernation (default).cmd"
)
