...
call "%windir%\GamerzOSModules\Scripts\setSvc.cmd" Spooler 4
call "%windir%\GamerzOSModules\Scripts\setSvc.cmd" PrintWorkFlowUserSvc 4

call "%windir%\GamerzOSModules\Scripts\settingsPages.cmd" /hide printers
