.\GamerzOSModules\initPowerShell.ps1
function Invoke-GamerzOSDiskCleanup {
...
# This is so that users can't attempt to revert from GamerzOSto stock with Restore Points
